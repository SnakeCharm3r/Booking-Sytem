...
return [
    ...
    */
    ...
    | sources to represent each model/table. These sources may then be
    ...
    */
    ...
    | than one user table or model and want to have separate password reset
    | settings based on user types.
    |
    | The expiry time is the number of minutes that each reset token will be
    | considered valid. This helps keep tokens short-lived for security.
    |
    */
